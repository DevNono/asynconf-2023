...
const Modal = ({
  ...
  <Fade triggerOnce duration={400}>
    <div
      ...
      <Zoom triggerOnce delay={350} className="absolute w-full -top-40">
        {topHexagon && (
          <div className="relative flex flex-col items-center justify-center gap-4 rounded-lg">
        ...
        {backArrow && (
          <Fade triggerOnce delay={1000}>
            <Link
              className="absolute flex items-center justify-center gap-2 top-8 left-8 text-main"
